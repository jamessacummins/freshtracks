...
<img src="Images/Fresh Tracks logo CMYK.jpg" width="300" height="75" alt="">
  ...
  <div class="collapse navbar-collapse" id="navbarNav" >
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Acquired Brain Injuries</a>
      </li>
      <li class="nav-item">
...
<div class ="container">
  ...
  <!-- Text bottom half -->
<div class="rantextbottom" href="#">As well as get on the tracks Inside</div>
<button type="button" class="dnButton btn-outline-primary">Donate Now</button>
...
<div class ="botb">
  ...
  <div class="btext1" href="#">
    Group programs provide speech and brain training.
  </div>
  <div class="btext1" href="#">
...
<!-- footer -->
<nav class="footer sticky-bottom navbar-expand-lg navbar-dark bg-dark">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="footerR" href="#">@FreshTracks 2022</div>
  </div>
    ...
    <script src = "https://maxcdn.boostrapcdn.com/boostrap/4.5.2/js/bootstrap.min.js"></script>
