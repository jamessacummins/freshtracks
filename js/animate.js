...
var zoomArray = Array.from(document.querySelectorAll(".donate-cta, #donate-button, #donate-image, #hero-donate-button, .section-icon, .section-image, .section-image-dash, .section-image-top"));
